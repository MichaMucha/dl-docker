...
MAINTAINER Michal Mucha <mjmucha@icloud.com>

ARG TENSORFLOW_VERSION=0.11.0rc1
...
RUN pip --no-cache-dir install --upgrade \
	https://storage.googleapis.com/tensorflow/linux/${TENSORFLOW_ARCH}/tensorflow-0.11.0rc2-cp35-cp35m-linux_x86_64.whl
